  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-primary tracking-tight">Bids & Proposals</h1>
          <p className="text-sm text-gray-500">Track and manage your proposals and RFPs.</p>
        </div>
        <button 
      ...
      <div className="bg-white border border-border rounded-lg shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="p-12 text-center text-gray-500">
            <div className="mb-2 text-lg font-medium text-gray-700">No Bids Found</div>
            <p className="text-sm">Get started by creating a new bid to track your RFP progress.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm whitespace-nowrap min-w-[800px]">
              <thead className="bg-gray-50 text-gray-600 border-b border-border">
                <tr>
                  <th className="px-4 py-3 font-semibold uppercase tracking-wider text-[11px]">Bid ID</th>
                  ...
                  <th className="px-4 py-3 font-semibold uppercase tracking-wider text-[11px]">Approval Status</th>
                  <th className="px-4 py-3 font-semibold uppercase tracking-wider text-[11px]">Submission Deadline</th>
                ...
                {bids.map((bid) => {
                  return (
                    <tr key={bid.id} className="hover:bg-gray-50 transition-colors group">
                      ...
                      <td className="px-4 py-3"><RagBadge status={bid.status} /></td>
                      <td className="px-4 py-3"><RagBadge status={bid.approval_status} /></td>
                      <td className="px-4 py-3"><DeadlineBadge days={daysUntil(bid.submission_deadline)} /></td>
